package com.teenthofabud.codingchallenge.sharenow.refresh.service.impl;


import com.teenthofabud.codingchallenge.sharenow.refresh.converter.PositionDTO2EntityConveter;
import com.teenthofabud.codingchallenge.sharenow.refresh.converter.VehicleDTO2EntityConveter;
import com.teenthofabud.codingchallenge.sharenow.refresh.filter.RestClientErrorHandler;
import com.teenthofabud.codingchallenge.sharenow.refresh.model.dto.ErrorDTO;
...
import com.teenthofabud.codingchallenge.sharenow.refresh.repository.VehicleRepository;
import com.teenthofabud.codingchallenge.sharenow.refresh.service.*;
...
public class Car2GoVehicleRefreshServiceImpl implements VehicleRefreshService {
    ...
    @Value("${vs.search.location:Stuttgart}")
    ...
    @Override
    @Scheduled(cron = "${vs.refresh.cron.expression:*/30 * * * *}")
